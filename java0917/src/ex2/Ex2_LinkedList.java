...
/**
 *
 * @author kosta Document : Ex2_LinkedList Created on : 김현철 2014. 9. 17, 오전
 * 11:22:47
 */
//jdk5 부터 추가된 인터페이스인 Queue 인터페이스 구현한 클래스이다.
...
// ArrayList는 순차적인 데이터를 읽어 낼 때 또는 순차적인 추가 삭제
// 일때는 빠름
// LinkedList : 읽기 시간이 느리다. 중간 데이터를 추가/삭제 빠르다.
